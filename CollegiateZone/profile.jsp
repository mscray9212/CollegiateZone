...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/examples/index_main.jsp"><img id="identity" src="/examples/img/logo.png"></a>
        </div>
  ...
  <!--footer end here-->
    ...
    <script type="text/javascript" src="/examples/script/profile.js"></script>
