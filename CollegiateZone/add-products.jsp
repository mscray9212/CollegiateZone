...
<%@ page import="com.java.collegiatezone.models.Product, java.util.ArrayList" %>
...
<head>
    ...
    <link rel="icon" href="/examples/img/faviconlogo.png">

    <title>Add-Product</title>
    <!-- Bootstrap core CSS -->
    <link href="/examples/index_files/bootstrap.css" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="/examples/index_files/non-responsive.css" rel="stylesheet">
    <!-- Custom CSS created @Andres Burden -->
    <link href="/examples/css/style.css" rel="stylesheet" type="text/css">
    <!-- Default Font Awesome CSS with the default Bootstrap CSS -->
    <link href="/examples/font-awesome-4.2.0/css/font-awesome.css" rel="stylesheet">
    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->

    <script src="/examples/index_files/ie-emulation-modes-warning.js"></script>
...
<body>
    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="/examples/index_main.jsp"><img alt="" id="identity" src=
                "/examples/img/logo.png"></a>
            </div>

            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="/examples/contact.jsp">Contact Us</a>
                    </li>

                    <li>
                        <a href='/examples/blank.jsp'>Sign Out</a>
                    </li>
                        ...
                        <c:if test="${ sessionScope.first_name != null}">
                            <div class="dropdown head_btn">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href='/examples/profile.jsp'>Profile</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1"  href='/MyProductList/test'>My Products</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1"  href='/examples/add-products.jsp'>Add Product</a></li>
                                </ul>
                            </div>
                         </c:if>
                    </li>
        ...
        <div id="search_bar">
            <div class="container">
                <div class="form-inline float_left" id="global_form">
                    <form class="search_form form-group" method="get" action="/examples/SearchServlet" name="SearchServlet">
                ...
                <div class="float_right" id="check_out">
                    <a class="check_out_utility white_link" href="/examples/index_main.jsp"><span id=
                                    ...
                                    <form   class="add_product" id="add_product_form"
                                        ...
                                        <div class="form_row button_row float_right">
                                            <div class="form_column_btn">
                                              <a class="cancel_btn" href="/examples/index_main.jsp">Cancel</a>
                ...
                <div class="right_div">
                    <div class="right_product_area_product_cart_faq">
                        <div class="right_product_area_product_cart_inner_faq">
                            <img alt="" src="/examples/img/faq.jpg">
                    ...
                    <div class="right_product_area">
                        <div class="right_sponsor_area">
                            <ul>
                                <li>
                                <a href="http://www.chegg.com/" target="_blank"><img alt="" src="/examples/img/cheg.png"></a>

                                <p>Get better grades. See step-by-step solutions.</p>
                                </li>

                                <li>
                                <a href="https://www.salliemae.com" target="_blank"><img alt="" src="/examples/img/sal.png"></a>

                                <p>It's Time to Talk About Paying for College.</p>
                                </li>

                                <li>
                                <a href="https://www.amazon.com" target="_blank"><img alt="" src="/examples/img/ama.png"></a>

                                <p>When you want it, when you need it.</p>
                                </li>

                                <li>
                                <a href="https://www.pearson.com"><img src="/examples/img/pea.png"></a>
    ...
    <li><a href="/examples/terms-and-conditions.html">Terms of Use</a></li>
    ...
    <ul>
    <li><a href="https://twitter.com/CollegiateZ" target="_blank"><img src="/examples/img/tw.png" alt="Twitter Account"></a></li>
    <li><a href="https://www.facebook.com/pages/CollegiateZone/699549393449050" target="_blank"><img src="/examples/img/fb.png" alt="Facebook Account"></a></li>
    </ul>
    </div>
    </div>
    </div>
    ...
    <script src="/examples/index_files/jquery.js"></script> <script src="/examples/index_files/bootstrap.js"></script> <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="/examples/index_files/ie10-viewport-bug-workaround.js"></script>
    <script type="text/javascript" src="/examples/script/common.js"></script>
</body>
</html>