...
<html lang="en"><head>
        ...
        <link rel="stylesheet" href="/examples/font-awesome-4.2.0/css/font-awesome.css">
    ...
    <body>
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/examples/index_main.jsp"><img src="/examples/img/logo.png" alt="" id="identity"></a>
                </div>
                <div class="navbar-collapse collapse">                   
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <c:if test="${ sessionScope.first_name != null}">
                 		...
                 		<c:if test="${ sessionScope.first_name == null}">
                 			<a href='/examples/login.jsp'>Sign In</a>
                 		</c:if>  
                        </li>
                		<li>
	              		<c:if test="${ sessionScope.first_name != null}">
            ...
            <div id="search_bar">
                <div class="container">
                    ...
                    <div id="check_out" class="float_right">
                        <a class="check_out_utility white_link" href="/examples/cart.jsp">
                ...
                <div class="row">
                        ...
                        <div class=" left_div_product_inner_top">
                            <div class=" left_div_small_inner border">
                                <div class=" slider_div">
                                    <img src="/examples/img/pro_ban_big.png" alt="">

                                    <ul class="no_list_style">
                                        <li><img src="/examples/img/pro_ban_thumb.png" alt=""></li>
                                        <li><img src="/examples/img/pro_ban_thumb.png" alt=""></li>
                                        <li><img src="/examples/img/pro_ban_thumb.png" alt=""></li>
                                        <li><img src="/examples/img/pro_ban_thumb.png" alt=""></li>
                                    </ul>                                   
                                ...
                                <div class="des_title">
                                    ...
                                    <img src="/examples/img/vertise.png" alt="" class="pull-left">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 right_div">
                        <div class="right_product_area">
                            ...
                            <ul>
                                <li><img src="/examples/img/sm_pro.png" alt="">
        ...
        <script src="/examples/index_files/jquery.js"></script>
        <script src="/examples/index_files/bootstrap.js"></script>
