  ...
  <body>
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/examples/index_main.jsp"><img src="/examples/img/logo.png" alt="logotype" id="identity"></a>
        </div>
    ...
    <div class="container">
        <div class="center main_center_content">
            ...
            <div class="sign_in">
                <p class="supplemental_hint">Don't Have an Account?  <a href="/examples/sign-up.jsp">Register</a></p>
                ...
                <p class="supplemental_hint" id="forgot_password">Forgot Password?  <a href="/examples/reset-password.jsp">Click here</a></p>
            </div>
        </div>
    </div>
    ...
    <ul>
    <li><a href="/examples/contact.jsp">Contact Us</a></li>
    <li><a href="/examples/contact.jsp">Terms of Use</a></li>
