...
<html lang="en"><head>
    ...
    <!-- Bootstrap core CSS -->
        ...
        <script src="/examples/script/common.js"></script>
    	<script src="/examples/index_files/ie-emulation-modes-warning.js"></script>
    	<script src="/examples/code.jquery.com/jquery-1.10.2.js"></script>
  		<script src="/examples/code.jquery.com/ui/1.11.2/jquery-ui.js"></script>
    ...
    <body>
							                                ...
							                                <li>
							                                    ...
							                                    <div class="big_pro_right">
							                                        ...
							                                        <div class="left_pro_footer cart_loc">
							                                            ...
							                                            <!--  <h5>Qty. 1</h5>-->
							                                            <a href="/examples/EditProductInfo/text?product_id=${product.product_ID }">Edit</a>
                    ...
                    <!--right side start here-->
                        ...
                        <div class="right_product_area_product_cart_faq">   
                            <div class="right_product_area_product_cart_inner_faq"> 
                                <img src="/examples/img/faq.jpg" alt="">
        ...
        <section>
            <div class="banner_bottom">
                <img src="/examples/img/banner_2.png" alt="">
            </div>            
        </section>
        <div class="clearfix"></div>
